...
export default {
    ...
    methods: {
        ...
        copiedPopup: function() {
            ...
            copy_button.innerHTML = "Just Copied";
...
<template>
    ...
    <div v-if="isLoading" style="position: absolute; bottom: 0;"><a href="https://www.flaticon.com/free-icons/loading" title="loading icons">Loading icons created by Freepik - Flaticon</a></div>
</template>
